 ...
 */
final class Version20250424230651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_NEGOCIATION (NEG_ID INT AUTO_INCREMENT NOT NULL, NEG_REQUESTED_PRICE INT NOT NULL, NEG_STATUS VARCHAR(255) NOT NULL, NEG_CREATED_AT DATE NOT NULL, NEG_RESPONSE_AT DATE NOT NULL, NEG_CHALLENGE_PRICE INT DEFAULT NULL, NEG_IS_CLOSE TINYINT(1) DEFAULT 0, USR_ID INT DEFAULT NULL, ROOM_ID INT DEFAULT NULL, INDEX IDX_C24C62D4C4DC529D (USR_ID), INDEX IDX_C24C62D4531FC869 (ROOM_ID), PRIMARY KEY(NEG_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
