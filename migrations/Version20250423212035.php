 ...
 */
final class Version20250423212035 extends AbstractMigration
{
    ...
    {
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_HOTEL (HTL_ID INT AUTO_INCREMENT NOT NULL, HTL_NAME VARCHAR(255) NOT NULL, HTL_ADRESS VARCHAR(255) NOT NULL, HTL_CITY VARCHAR(255) NOT NULL, HTL_COUNTRY VARCHAR(255) NOT NULL, HTL_DESCRIPTION VARCHAR(255) NOT NULL, HTL_CATEGORIE VARCHAR(255) NOT NULL, HTL_CHILDREN TINYINT(1) NOT NULL, HTL_ANIMAL TINYINT(1) NOT NULL, HTL_TYPE_CITY VARCHAR(255) NOT NULL, HTL_TRANSPORT JSON NOT NULL, HTL_RESTORATION VARCHAR(255) NOT NULL, HTL_WELLNESS JSON NOT NULL, HTL_BUSINESS_SERVICE JSON NOT NULL, HTL_COMFORT JSON NOT NULL, HTL_ADD_SERVICES JSON NOT NULL, HTL_PMR TINYINT(1) NOT NULL, HTL_BABY TINYINT(1) NOT NULL, USR_ID INT DEFAULT NULL, INDEX IDX_A2A6B370C4DC529D (USR_ID), PRIMARY KEY(HTL_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_NEGOCIATION (NEG_ID INT AUTO_INCREMENT NOT NULL, NEG_REQUESTED_PRICE INT NOT NULL, NEG_STATUS VARCHAR(255) NOT NULL, NEG_CREATED_AT DATE NOT NULL, NEG_RESPONSE_AT DATE NOT NULL, NEG_CHALLENGE_PRICE INT DEFAULT NULL, USR_ID INT DEFAULT NULL, INDEX IDX_C24C62D4C4DC529D (USR_ID), PRIMARY KEY(NEG_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_PAYMENT (PAY_ID INT AUTO_INCREMENT NOT NULL, PAY_STRIPE_ID INT NOT NULL, PAY_AMOUNT INT NOT NULL, PAY_STATUS VARCHAR(255) NOT NULL, PAY_METHOD VARCHAR(255) NOT NULL, PAY_RECEIPT VARCHAR(255) NOT NULL, PAY_CREATED_AT DATE NOT NULL, USR_ID INT DEFAULT NULL, INDEX IDX_62BCB8F7C4DC529D (USR_ID), PRIMARY KEY(PAY_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_RESERVATION (RES_ID INT AUTO_INCREMENT NOT NULL, RES_CREATED_AT DATE NOT NULL, RES_START_DATE DATE NOT NULL, RES_END_DATE DATE NOT NULL, RES_PRICE INT NOT NULL, RES_STATUS VARCHAR(255) NOT NULL, USR_ID INT DEFAULT NULL, INDEX IDX_35651C59C4DC529D (USR_ID), PRIMARY KEY(RES_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_ROOM (ROOM_ID INT AUTO_INCREMENT NOT NULL, ROOM_NAME VARCHAR(255) NOT NULL, ROOM_DESCRIPTION LONGTEXT NOT NULL, ROOM_BASE_PRICE INT NOT NULL, ROOM_MAX_GUESTS INT NOT NULL, HTL_ID INT DEFAULT NULL, RES_ID INT DEFAULT NULL, INDEX IDX_56E1861A7972BF64 (HTL_ID), INDEX IDX_56E1861A8EC56762 (RES_ID), PRIMARY KEY(ROOM_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_THRESHOLD (THR_ID INT AUTO_INCREMENT NOT NULL, THR_MINIMUM INT NOT NULL, THR_MAXIMUM INT NOT NULL, THR_START_DATE DATE NOT NULL, THR_END_DATE DATE NOT NULL, HTL_ID INT DEFAULT NULL, INDEX IDX_84AC54D87972BF64 (HTL_ID), PRIMARY KEY(THR_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
