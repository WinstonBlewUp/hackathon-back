 ...
 */
final class Version20250425143007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_NEGOCIATION (NEG_ID INT AUTO_INCREMENT NOT NULL, NEG_REQUESTED_PRICE INT NOT NULL, NEG_STATUS VARCHAR(255) NOT NULL, NEG_CREATED_AT DATETIME NOT NULL, NEG_RESPONSE_AT DATETIME NOT NULL, NEG_CHALLENGE_PRICE INT DEFAULT NULL, NEG_IS_CLOSE TINYINT(1) NOT NULL, USR_ID INT DEFAULT NULL, ROOM_ID INT DEFAULT NULL, INDEX IDX_C24C62D4C4DC529D (USR_ID), INDEX IDX_C24C62D4531FC869 (ROOM_ID), PRIMARY KEY(NEG_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_RESERVATION (RES_ID INT AUTO_INCREMENT NOT NULL, RES_CREATED_AT DATE NOT NULL, RES_START_DATE DATE NOT NULL, RES_END_DATE DATE NOT NULL, RES_PRICE INT NOT NULL, RES_STATUS VARCHAR(255) NOT NULL, USR_ID INT DEFAULT NULL, ROOM_ID INT DEFAULT NULL, INDEX IDX_35651C59C4DC529D (USR_ID), INDEX IDX_35651C59531FC869 (ROOM_ID), PRIMARY KEY(RES_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
