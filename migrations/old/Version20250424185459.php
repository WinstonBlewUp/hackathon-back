 ...
 */
final class Version20250424185459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MTC_RESERVATION (RES_ID INT AUTO_INCREMENT NOT NULL, RES_CREATED_AT DATE NOT NULL, RES_START_DATE DATE NOT NULL, RES_END_DATE DATE NOT NULL, RES_PRICE INT NOT NULL, RES_STATUS VARCHAR(255) NOT NULL, USR_ID INT DEFAULT NULL, room_id INT NOT NULL, INDEX IDX_35651C59C4DC529D (USR_ID), INDEX IDX_35651C5954177093 (room_id), PRIMARY KEY(RES_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`
        SQL);
        $this->addSql(<<<'SQL'
